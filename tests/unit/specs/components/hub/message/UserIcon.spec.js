...
import UserIcon from 'app/components/hub/message/UserIcon.vue'
...
describe('components/hub/message/UserIcon.vue', function () {
  it('should render correctly', function () {
    const vm = render(`<user-icon v-bind="{ sender: sender }"></user-icon>`, this)

    vm.$el.should.have.class('c-hub-message-user-icon')
