...
import TextMessage from 'app/components/hub/message/Text.vue'
...
describe('components/hub/message/Text.vue', function () {
  it('should render correctly', function () {
    const vm = render(`<text-message v-bind="{ message: message }"></text-message>`, this)
