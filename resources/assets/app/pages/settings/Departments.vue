<template>
<container-window :title="Departments" :subtitle="subtitle">
    <settings-header :title="Departments">
    ...
    <modal name="Add new department" :open="onAdd" @hide="onCancel">
        <div class="card">
            <h4 class="card-header bg-white">{{ title }} </h4>

            <div class="card-block">
                <input-text title="Name of the department" required v-model="department.name"
                            :feedback="errors.name"></input-text>
                <input-text title="Department acronym" v-model="department.short_name"
                            :feedback="errors.short_name"></input-text>
    ...
    <div class="container py-2">
        ...
        <div class="row my-2">
            <settings-card class="col-xs-12 col-lg-6" v-for="(department, index) in nonAcademic"
...
export default{
  ...
  methods: {
    ...
    departmentClicked (index, context) {
      ...
      ...mapActions('departments', ['store', 'update'])
    },
}
</script>
